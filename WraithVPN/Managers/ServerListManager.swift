...
final class ServerListManager: ObservableObject {
    ...
    func refresh() async {
        ...
        if ScreenshotMode.mockRegions {
            let mockRegions = [
                VPNServer.stub(nodeId: "nbg1", region: "de"),
                VPNServer.stub(nodeId: "hel1", region: "fi"),
                VPNServer.stub(nodeId: "ash", region: "us"),
                VPNServer.stub(nodeId: "hil", region: "us"),
                VPNServer.stub(nodeId: "ewr1", region: "us"),
                VPNServer.stub(nodeId: "sgp2", region: "sg"),
                VPNServer.stub(nodeId: "nrt1", region: "jp"),
                VPNServer.stub(nodeId: "bom1", region: "in"),
                VPNServer.stub(nodeId: "hil2", region: "us"),
            ]
