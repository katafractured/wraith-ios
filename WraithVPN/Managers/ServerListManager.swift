...
final class ServerListManager: ObservableObject {
    ...
    func refresh() async {
        ...
        if ScreenshotMode.mockRegions {
            let mockRegions = [
                VPNServer(nodeId: "nbg1", site: "nbg1", region: "de", displayName: "Frankfurt", ipv4: "178.104.49.211", ipv6: "fd10:0:1::1", endpoints: .init(primary: "nbg1.example.com", secondary: "178.104.49.211"), publicKey: ""),
                VPNServer(nodeId: "hel1", site: "hel1", region: "fi", displayName: "Helsinki", ipv4: "204.168.224.243", ipv6: "fd10:0:2::1", endpoints: .init(primary: "hel1.example.com", secondary: "204.168.224.243"), publicKey: ""),
                VPNServer(nodeId: "ash", site: "ash", region: "us", displayName: "Ashburn", ipv4: "87.99.128.159", ipv6: "fd10:0:6::1", endpoints: .init(primary: "ash.example.com", secondary: "87.99.128.159"), publicKey: ""),
                VPNServer(nodeId: "hil", site: "hil", region: "us", displayName: "Hillsboro", ipv4: "5.78.178.202", ipv6: "fd10:0:7::1", endpoints: .init(primary: "hil.example.com", secondary: "5.78.178.202"), publicKey: ""),
                VPNServer(nodeId: "ewr1", site: "ewr1", region: "us", displayName: "Newark", ipv4: "64.176.215.96", ipv6: "fd10:0:13::1", endpoints: .init(primary: "ewr1.example.com", secondary: "64.176.215.96"), publicKey: ""),
                VPNServer(nodeId: "sgp2", site: "sgp2", region: "sg", displayName: "Singapore", ipv4: "149.28.132.184", ipv6: "fd10:0:8::1", endpoints: .init(primary: "sgp2.example.com", secondary: "149.28.132.184"), publicKey: ""),
                VPNServer(nodeId: "nrt1", site: "nrt1", region: "jp", displayName: "Tokyo", ipv4: "167.179.82.216", ipv6: "fd10:0:10::1", endpoints: .init(primary: "nrt1.example.com", secondary: "167.179.82.216"), publicKey: ""),
                VPNServer(nodeId: "bom1", site: "bom1", region: "in", displayName: "Mumbai", ipv4: "65.20.76.56", ipv6: "fd10:0:12::1", endpoints: .init(primary: "bom1.example.com", secondary: "65.20.76.56"), publicKey: ""),
                VPNServer(nodeId: "hil2", site: "hil2", region: "us", displayName: "Hillsboro-2", ipv4: "5.78.207.199", ipv6: "fd10:0:3::1", endpoints: .init(primary: "hil2.example.com", secondary: "5.78.207.199"), publicKey: ""),
            ]
